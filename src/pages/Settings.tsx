      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#0f172a] rounded-2xl shadow-sm border border-slate-800 overflow-hidden">
            ...
            <div
              className="flex items-center gap-4 p-4 active:bg-slate-800 transition-colors cursor-pointer border-b border-slate-800 group"
        ...
        <div className="text-center space-y-1">
          <div className="text-[10px] text-slate-700 font-bold uppercase tracking-[0.2em]">
            PWA Version 1.0.0
          </div>
          <div className="text-[10px] text-slate-700 font-medium italic">
            Handcrafted for Warung Indonesia
          </div>
        </div>
      </div>
