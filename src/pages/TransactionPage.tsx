...
const MOCK_PRODUCTS = [
    ...
    },
    {
        ...
        stock_qty: 100,
        units: [
            { id: 'u6', unit_type: 'Botol', price_sell: 4000, price_cost: 3200, qty_per_base_unit: 1 },
            { id: 'u7', unit_type: 'Dus', price_sell: 96000, price_cost: 76800, qty_per_base_unit: 24 },
        ],
    },
    {
        id: '6',
        ...
        stock_qty: 50,
        units: [
            { id: 'u8', unit_type: 'Pcs', price_sell: 10000, price_cost: 8500, qty_per_base_unit: 1 },
        ],
    },
];

const TOP_CATEGORIES = ['Semua', 'Rokok & Tembakau', 'Minuman', 'Mie & Snack', 'Sembako'];
    ...
    return (
        <>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {searchResults.map((product) => {
                                    ...
                                    return (
                                        <button
                                            key={product.id}
                                            onClick={() => handleToggleProduct(product.id, product.name)}
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`font-bold text-xs line-clamp-2 min-h-[2.5em] transition-colors tracking-tight ${
                                                    inCart ? 'text-primary' : 'text-slate-200 group-hover:text-primary'
                                                } ${qty > 1 ? 'pl-8' : ''}`}
                                            >
                                                {product.name}
                                            </div>
                                    ...
                                    items.map((item) => {
                                        ...
                                        return (
                                            <CartItem
                                                ...
                                                onSetDiscount={(discount) => setDiscount(item.cart_id, discount)}
                                            />
                                        );
                                    })
                                )}
            ...
            <ConfirmDialog
                ...
                title={`${productToRemove?.name} pada keranjang akan terhapus juga.`}
                message=""
                confirmText="Setuju"
                cancelText="Batal"
                variant="warning"
